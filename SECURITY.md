...
- **SSRF:** private / loopback / link-local targets are **blocked** by default for automated fetches (`crawlix.services.net.ssrf`). Intranet audits require an explicit allow flag (future UI).
